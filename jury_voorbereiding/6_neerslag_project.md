...
- **Titel van het project:** AnimeShop
...
- **Probleemstelling:** Veel standaard webshops zijn visueel saai of missen een specifieke doelgroep-focus. AnimeShop biedt een op maat gemaakte, dark-mode/neon getinte winkelervaring met een robuuste backend.
...
## 3. Analyse
- **Functionele vereisten:** Bezoekers moeten producten kunnen zoeken, filteren en in een winkelmand plaatsen. Gebruikers moeten kunnen inloggen en afrekenen. Admins moeten CRUD-rechten hebben over de catalogus.
...
- **Technologieën:** Laravel 13 (PHP 8.4), MySQL, Tailwind CSS, Alpine.js, Stripe API.
...
- **API’s:** Stripe (Checkout Session API voor betalingen).
...
- Officiële Laravel Documentatie (Routing, Eloquent, Mail).
